...
origin) and $\vec{m}_i$ is the location of the $i$\textsuperscript{th} obstacle. The vectors represented
...
\caption{The difference between the actual and predicted values in the $x$-axis.}
\label{fig:1}
\end{figure}
...
\caption{The difference between the actual and predicted values in the $y$-axis.}
\label{fig:2}
\end{figure}
...
\caption{The difference between the actual and predicted values in $\theta$.}
\label{fig:3}
\end{figure}
