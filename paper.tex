...
the EKF's entire algorithmic complexity. The a priori and the a posteriori estimation steps are 
...
First, to generate the a priori estimate, the \texttt{motionModelUpdate()} method is called by 
...
Second, to generate the a posteriori estimate, the \texttt{ekfUpdate} function calls the 
